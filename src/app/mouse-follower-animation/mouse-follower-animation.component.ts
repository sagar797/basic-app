...
@Component({
  selector: 'app-mouse-follower-animation',
  templateUrl: './mouse-follower-animation.component.html',
  styleUrls: ['./mouse-follower-animation.component.scss'],
})
export class MouseFollowerAnimationComponent implements OnInit {
  SCREEN_WIDTH;
  SCREEN_HEIGHT;
