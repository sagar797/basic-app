...
@Component({
  selector: 'app-background-animated-text',
  templateUrl: './background-animated-text.component.html',
  styleUrls: ['./background-animated-text.component.scss'],
})
export class BackgroundAnimatedTextComponent implements OnInit {
